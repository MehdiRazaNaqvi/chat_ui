        ...
        <div className="chat_base" style={{ width: "50rem", height: "min-content", minHeight: "100vh", position: "relative" }}>
            ...
            {count?.current_user?.email != "" ?
                ...
                <span className="send_tab" style={{ position: "absolute", bottom: "0px" }} >
                    ...
                    <Input style={{ height: "4rem" }} size="lg" className="form-control" type="text" placeholder="Type message" value={message} onChange={(e) => setmessage(e.target.value)} />

                    <Button size="lg" onClick={() => sendchat()} className="send_btn btn btn-outline-success "><img src="https://img.icons8.com/external-febrian-hidayat-flat-febrian-hidayat/50/000000/external-Send-user-interface-febrian-hidayat-flat-febrian-hidayat.png" className="send-icon" /></Button>
